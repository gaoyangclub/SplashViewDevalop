...
-(UIImageView *)logoImg{
    if (_logoImg == NULL) {
        ...
        _logoImg.layer.masksToBounds = true;
...
-(void)display{
//            CABasicAnimation *animation1 = [CABasicAnimation animationWithKeyPath:@"progress"];//测试圆环旋转
//            // 向后移动同时绕Y轴逆时针旋转90度
...
//    
//            CACircleLayer* layer = [CACircleLayer new];
//            layer.frame = CGRectMake(100, 100, 100, 100);
//            layer.lineWidth = 30;
//            layer.strokeColor = [UIColor blueColor].CGColor;
//            layer.backgroundColor = [UIColor brownColor].CGColor;
//    //        layer.progress = 0.7;//M_PI_2 * 3;
//    
...
//    animationGroup.removedOnCompletion = NO;    // 动画结束时停止，不回复原样
    ...
    [self.logoImg.layer addAnimation:animationGroup forKey:nil];//@"FristAnimation"
}
...
//            animation.removedOnCompletion = NO;    // 动画结束时停止，不回复原样
...
//        }
////        else if (anim == [self.logoImg.layer animationForKey:@"SecondAnimation"]){
////            [self animationDaDaLogo];//继续播放
////        }
//    }
//}
